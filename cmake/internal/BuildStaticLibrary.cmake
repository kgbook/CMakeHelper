if(NOT LOCAL_MODULE)
    message(FATAL_ERROR "LOCAL_MODULE must be set before including BUILD_STATIC_LIBRARY")
endif()
...
if(LOCAL_ARCHIVE_OUTPUT_DIRECTORY)
    set_target_properties(${LOCAL_MODULE} PROPERTIES
        ARCHIVE_OUTPUT_DIRECTORY ${LOCAL_ARCHIVE_OUTPUT_DIRECTORY})
endif()
